...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    h1 { color: #17365d; font-size: 18px; margin: 0 0 5px; text-align: center; }
    .subtitle { color: #64748b; font-size: 9px; margin: 0 0 14px; text-align: center; }
    table { border-collapse: collapse; table-layout: fixed; width: 100%; }
    thead { display: table-header-group; }
    tr { break-inside: avoid; page-break-inside: avoid; }
    th, td { border: 1px solid #94a3b8; overflow-wrap: anywhere; padding: 5px 6px; text-align: left; vertical-align: top; }
    th { background: #17365d; color: #ffffff; font-size: 9px; font-weight: 700; text-align: center; }
    td:nth-child(1), td:nth-child(2), td:nth-child(3), td:nth-child(5), td:nth-child(6), td:nth-child(8) { text-align: center; }
    td:nth-child(9) { line-height: 1.35; white-space: normal; }
